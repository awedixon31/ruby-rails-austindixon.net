...
class SkillsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create skill" do
    assert_difference("Skill.count") do
      post skills_url, params: { skill: { name: @skill.name, proficiency: @skill.proficiency } }
    end
  ...
  test "should update skill" do
    patch skill_url(@skill), params: { skill: { name: @skill.name, proficiency: @skill.proficiency } }
